...
import 'package:school_app/features/list_student_profile/screen/student_dilegence.dart';
import 'package:school_app/features/list_student_profile/screen/student_profile.dart';
    ...
    return MainContainer(
      child: Scaffold(
        ...
        appBar: appBarCommonV1(
          context,
          strTitle: '${widget.data!.name} - Thông tin', callback: (){Navigator.pop(context);}
        ),
        body: SafeArea(
          child: Container(
                        ...
                        return Container(
                          ...
                          child: Common().buttonCommon(
                              colors: _selectedIndex == index
                                  ...
                                  : CustomColors.yellowColor
                                      .withOpacity(0.5),
                              colorBorder: _selectedIndex == index
